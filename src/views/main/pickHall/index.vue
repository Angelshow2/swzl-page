  ...
  <div class="pickhall-container">
    <div class="top">
      ...
      <div class="right">
        ...
        <el-button @click="publishpick" icon="el-icon-circle-plus-outline" type="primary">发布拾物</el-button>
      </div>
    </div>
    ...
    <div v-if="!pickList.length" class="no-data">
      暂无数据
    </div>
...
import { getPickList, getItemClass } from '@/api/pickHall/index'
